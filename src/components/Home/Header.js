...
import '../../styles/index.css'; // Se precisar customizar estilos
                    ...
                    <div className="col-xxl-5">
                        <div className="text-center text-xxl-start">
                            <div className="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div className="text-uppercase">Design · Development </div>
                            </div>
                            <div className="fs-3 fw-light text-muted">Levo o seu negócio para a internet</div>
                    ...
                    <div className="col-xxl-7">
                        <div className="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div className="profile bg-gradient-primary-to-secondary position-relative">
                                ...
                                {/* Dots 2 */}
                                <div className="dots-2 position-absolute">
                                  <svg
                                      version="1.1"
                                      xmlns="http://www.w3.org/2000/svg"
                                      xmlnsXlink="http://www.w3.org/1999/xlink"
                                ...
                                {/* Dots 3 */}
                                <div className="dots-3 position-absolute">
                                  <svg
                                    version="1.1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlnsXlink="http://www.w3.org/1999/xlink"
                                ...
                                {/* Dots 4 */}
                                <div className="dots-4 position-absolute">
                                <svg
                                  version="1.1"
                                  xmlns="http://www.w3.org/2000/svg"
                                  xmlnsXlink="http://www.w3.org/1999/xlink"
